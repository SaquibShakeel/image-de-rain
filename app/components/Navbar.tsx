  ...
  return (
    <nav className="w-screen bg-teal-500 h-fit overflow-hidden">
        <div className="py-4 lg:px-8 px-4 max-w-[1280px] h-16 m-auto text-white flex items-center justify-between">
            <div>
                <h1 className="lg:text-2xl text-xl uppercase tracking-wider cursor-pointer font-bold">Image De-Rain</h1>
            </div>
            ...
            <div id="mobileNav"
                className={`fixed flex flex-col gap-8 pt-16 px-4 text-xl uppercase bg-teal-500 h-full inset-0 top-16 w-[70%] ${isMenuOpen? "left-0": "left-[-70%]"} ease-in-out duration-500 cursor-pointer`}>
                <span>Services</span>
                <span>About</span>
                <span>Contact</span>
            </div> */}
